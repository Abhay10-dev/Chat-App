...
import { Copy, LogOut, Send, MessageSquareOff, ChevronUp } from 'lucide-react';
...
export default function ChatRoom() {
  ...
  function handleInputKeyDown(e) {
    ...
    // Shift+Enter → newline (natural textarea behaviour)
  }
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-950 text-white overflow-hidden">
        ...
        <div className="flex items-center gap-2 flex-none">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg
              bg-slate-800 hover:bg-red-900/40 border border-slate-700 hover:border-red-700/50
              text-slate-300 hover:text-red-400 transition-all duration-150"
          >
      ...
      <form
        onSubmit={handleSend}
        className="flex-none px-4 sm:px-6 py-3 bg-slate-900/90 backdrop-blur-sm border-t border-slate-800 flex items-end gap-3"
      >
        <textarea
          ref={inputRef}
          id="message-input"
